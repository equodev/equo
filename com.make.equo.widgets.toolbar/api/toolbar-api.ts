export class Linker{
  ...
  constructor() {
    this.toolItemBuilder = null;
    this.toolbarBuilder = new ToolbarBuilder(this);
  }

  public getToolbarBuilder() {
    return this.toolbarBuilder;
  }

  public getToolItemBuilder() {
    return this.toolItemBuilder;
  }

  public createNewToolItemBuilder(toolbar : EquoToolbar){
    this.toolItemBuilder = new ToolItemBuilder(this,toolbar);
    return this.toolItemBuilder;
  }

  public createNewToolbarBuilder(){
    this.toolbarBuilder = new ToolbarBuilder(this);
    return this.toolbarBuilder;
  }

  public createToolbar() : ToolbarBuilder{
    return this.toolbarBuilder;
  }
...
export class ToolbarBuilder{
  ...
  public build(): void {
    ...
    let toolitems = this.equoToolbar.getToolItems;
