 ...
 * <!-- end-user-doc -->
 * @see webdialog.WebdialogPackage
 * @generated
 */
public class WebdialogSwitch<T1> extends Switch<T1> {
	...
	protected T1 doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case WebdialogPackage.MBUTTON_TOGGLE: {
				MButtonToggle mButtonToggle = (MButtonToggle)theEObject;
				T1 result = caseMButtonToggle(mButtonToggle);
				if (result == null) result = caseWindowElement(mButtonToggle);
				if (result == null) result = caseUIElement(mButtonToggle);
				if (result == null) result = caseApplicationElement(mButtonToggle);
				if (result == null) result = caseLocalizable(mButtonToggle);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>MButton Toggle</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>MButton Toggle</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T1 caseMButtonToggle(MButtonToggle object) {
		return null;
	}
