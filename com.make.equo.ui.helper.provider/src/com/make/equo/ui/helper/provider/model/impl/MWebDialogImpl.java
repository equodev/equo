 ...
 * </p>
 * <ul>
 *   <li>{@link webdialog.impl.MWebDialogImpl#getButtons <em>Buttons</em>}</li>
 *   <li>{@link webdialog.impl.MWebDialogImpl#getToggle <em>Toggle</em>}</li>
 *   <li>{@link webdialog.impl.MWebDialogImpl#getTitle <em>Title</em>}</li>
 *   <li>{@link webdialog.impl.MWebDialogImpl#getMessage <em>Message</em>}</li>
 *   <li>{@link webdialog.impl.MWebDialogImpl#getParentShell <em>Parent Shell</em>}</li>
 *   <li>{@link webdialog.impl.MWebDialogImpl#isBlocker <em>Blocker</em>}</li>
 *   <li>{@link webdialog.impl.MWebDialogImpl#getResponse <em>Response</em>}</li>
 *   <li>{@link webdialog.impl.MWebDialogImpl#getType <em>Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MWebDialogImpl extends WindowImpl implements MWebDialog {
	...
	/**
	 * The cached value of the '{@link #getToggle() <em>Toggle</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getToggle()
	 * @generated
	 ...
	 * @ordered
	 */
	protected static final int RESPONSE_EDEFAULT = 0;
	...
	public MButtonToggle getToggle() {
		if (toggle != null && toggle.eIsProxy()) {
			InternalEObject oldToggle = (InternalEObject)toggle;
			toggle = (MButtonToggle)eResolveProxy(oldToggle);
			if (toggle != oldToggle) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WebdialogPackage.MWEB_DIALOG__TOGGLE, oldToggle, toggle));
			}
		}
		return toggle;
	}
	 ...
	 * @generated
	 */
	public MButtonToggle basicGetToggle() {
		return toggle;
	}
	 ...
	 */
	@Override
	public void setToggle(MButtonToggle newToggle) {
		MButtonToggle oldToggle = toggle;
		toggle = newToggle;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebdialogPackage.MWEB_DIALOG__TOGGLE, oldToggle, toggle));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case WebdialogPackage.MWEB_DIALOG__BUTTONS:
				return getButtons();
			case WebdialogPackage.MWEB_DIALOG__TOGGLE:
				if (resolve) return getToggle();
				return basicGetToggle();
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case WebdialogPackage.MWEB_DIALOG__BUTTONS:
				...
				return;
			case WebdialogPackage.MWEB_DIALOG__TOGGLE:
				setToggle((MButtonToggle)newValue);
				return;
			case WebdialogPackage.MWEB_DIALOG__TITLE:
