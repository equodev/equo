...
public class WebdialogAdapterFactory extends AdapterFactoryImpl {
	...
	protected WebdialogSwitch<Adapter> modelSwitch =
		new WebdialogSwitch<Adapter>() {
			...
			@Override
			public Adapter caseMButtonToggle(MButtonToggle object) {
				return createMButtonToggleAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link webdialog.MWebDialog <em>MWeb Dialog</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link webdialog.MButton <em>MButton</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link webdialog.MButtonToggle <em>MButton Toggle</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createMButtonToggleAdapter() {
		return null;
	}
